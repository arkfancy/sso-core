...
import com.arkfancy.sso.service.CustomKissoService;
...
//    }
	...
	protected static CustomKissoService customKissoService;

	/**
	 * Kisso 服务初始化
	 */
	public static CustomKissoService getKissoService() {
		if (customKissoService == null) {
			customKissoService = new CustomKissoService();
		}
		return customKissoService;
	}
    ...
    public static void clear401Login(HttpServletRequest request, HttpServletResponse response) throws IOException {
		getKissoService().clear401Login(request, response);
	}
